...
def main():
    ...
    for datasetSize in datasetSizes:
        ...
        searchHeavyGenerator = WorkloadGenerator(searchHeavyWorkloadFilename, datasetSize, 0.90, 0.05, 0.05)
        searchHeavyGenerator.generateAndSave()

        writeHeavyWorkloadFilename = f"workloads/escrita_{datasetSize}.csv"
        writeHeavyGenerator = WorkloadGenerator(writeHeavyWorkloadFilename, datasetSize, 0.10, 0.45, 0.45)
...
class WorkloadGenerator:
    ...
    """
    def __init__(self, targetFilename, operationCount, searchPercentage, insertPercentage, deletePercentage):
    ...
    def generateAndSave(self):
        ...
        with open(self.targetFilename, mode="w", newline="", encoding="utf-8") as fileHandle:
    ...
    def _createOperationsPool(self):
        ...
        return (["Search"] * searchCount) + (["Insert"] * insertCount) + (["Delete"] * deleteCount)
